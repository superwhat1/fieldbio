...
```{r Loading data}
BioDatFull <- read.csv("~/Queens/Teaching/Rob_Summercourse/BioDatFull2.csv")
Mapping_file <- read.csv("~/Queens/Teaching/Rob_Summercourse/mapping_file.csv")
OTU_table <- read.delim("~/Queens/Teaching/Rob_Summercourse/97_OTU_table_QIIME1.txt", header=T)
```
